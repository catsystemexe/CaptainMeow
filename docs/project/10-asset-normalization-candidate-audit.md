...
- Only `bgr_demo_stars_tile` declares `repeat.x: true` and a proven `seamless`
...
|---|---|---|---|
| `createBackgroundV2DesertTestScene` | static backdrop / camera-fixed | `desert_sky`: width 1672, height omitted | Built-in technical runtime authoring fixture |
| `createBackgroundV2DesertTestScene` | segment / far / sequence | `desert_far_mesas`: widthPx 1672, offsetY -120 | Built-in technical runtime authoring fixture |
| `createBackgroundV2DesertTestScene` | object / far / sequence | `desert_sun`: 836 x 471; `desert_clouds`: 1254 x 706 | Built-in technical runtime authoring fixture |
| `createBackgroundV2DesertTestScene` | segment / mid / sequence | `desert_mid_mesas_a`: widthPx 1672, offsetY -55; `desert_mid_mesas_b`: widthPx 1672, offsetY -35 | Built-in technical runtime authoring fixture |
| `createBackgroundV2DesertTestScene` | segment / near / sequence | `desert_near_band`: widthPx 1672, offsetY 35 | Built-in technical runtime authoring fixture |
| `createBackgroundV2DesertTestScene` | object / foreground / sequence | `desert_near_band`: 1003 x 565 | Built-in technical runtime authoring fixture |
| `createBackgroundV2VisualVerificationScene` | object / far / sequence | `bgr-test-solid`: 96 x 96 twice and 88 x 88 twice; `bgr-test-backdrop`: 112 x 112 twice | Debug runtime verification fixture |
| `createBackgroundV2VisualVerificationScene` | segment / near / sequence | `bgr-test-stripes`: widthPx 128, offsetY 300 | Debug runtime verification fixture |
| `createBackgroundV2VisualVerificationScene` | object / foreground / sequence | `bgr-test-marker`: 128 x 128 | Debug runtime verification fixture |
...
The three demo raster IDs and canonical `b1_pixel_stars` ID have no known
