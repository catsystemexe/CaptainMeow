...
for (const text of ["STATES", "ds-fsm-state-list", "ds-fsm-selected-state-editor", "Behavior", "Formation", "Trigger", "Advanced", "Override formation for this state"]) {
...
assert(source.includes("+ New state"), "inline new state button is present");
