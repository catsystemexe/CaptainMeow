...
assert(source.indexOf("fsmLabSection.appendChild(fsmBasicSection)") < source.indexOf("fsmLabSection.appendChild(presetPanel)"), "FSM LAB authoring panel remains below Basic Setup");
