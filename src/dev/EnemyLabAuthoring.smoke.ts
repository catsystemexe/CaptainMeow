...
for (const text of ["preset:", "states:", "behav:", "trigger:", "Advanced", "Diagnostics", "BUILT-IN / READ ONLY", "FsmPresetAuthoringModel"]) assert(source.includes(text), `missing ${text}`);
