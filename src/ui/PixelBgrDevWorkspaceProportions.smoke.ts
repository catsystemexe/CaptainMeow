...
assert.match(layout, /grid-template-columns:\s*clamp\(175px,\s*17vw,\s*205px\)\s+minmax\(0,\s*1fr\)\s+clamp\(200px,\s*20vw,\s*240px\)/, "side docks stay compact while the game receives all remaining width");
