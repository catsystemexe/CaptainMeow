...
export class PixelBgrLabUI {
  ...
  private renderOwned(): void {
    ...
    if (v2Scene) {
      if (this.getActiveDevLab() === "scene") this.workspace.right.appendChild(this.v2SelectedSpace ? this.renderSpaceInspector(v2Scene) : this.renderSceneAssetContext());
  ...
  private selectV2Space(selection:V2SpaceSelection,render=true):void {this.v2SelectedSpace=selection;if(render){this.render();this.syncOverlay();}}
  private applySpaceEdit(result:SpaceEditResult):void {if(!result.ok){this.message=result.error;this.render();return;}this.message="";this.v2SelectedSpace=result.selection;setBackgroundSceneV2(result.scene,globalThis);}
  ...
  private applySpaceDelete(scene:BackgroundSceneV2,selection:V2SpaceSelection):void {const result=deleteSpace(scene,selection);if(!result.ok){this.message=result.error;this.render();return;}this.message="";this.v2SelectedSpace=null;setBackgroundSceneV2(result.scene,globalThis);}
  ...
  private syncOverlay(): void {
    ...
    if(v2Scene&&this.v2SelectedSpace?.kind==="zone"){this.syncZoneOverlay(v2Scene,this.v2SelectedSpace.id);return;}
