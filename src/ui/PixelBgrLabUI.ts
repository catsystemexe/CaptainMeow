...
export const PIXEL_BGR_TIMELINE_ZOOM_LEVELS = [0.75, 1, 1.25, 1.5, 2, 3, 4] as const;
...
export class PixelBgrLabUI {
  ...
  private renderV2Timeline(projection: V2TimelineProjection): HTMLElement {
    ...
    for(const lane of projection.lanes){
      ...
      gutterRow.appendChild(label);gutter.appendChild(gutterRow);
    }
