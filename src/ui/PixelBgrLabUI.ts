...
export class PixelBgrLabUI {
  ...
  private renderOwned(): void {
    ...
    if (v2Scene) {
      ...
      inspector.append(this.renderV2SegmentInspector(),this.renderV2ObjectInspector(),this.renderPreview([],projection.bounds));
