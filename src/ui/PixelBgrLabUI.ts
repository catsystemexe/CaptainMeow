...
export class PixelBgrLabUI {
  ...
  private renderOwned(): void {
    ...
    if (v2Scene) {
      ...
      const transportBlock=el("div","cm-v2-left-block cm-v2-transport-block");transportBlock.append(this.renderPreview([],projection.bounds,true));this.root.appendChild(transportBlock);
      this.syncOverlay();
      return;
    }
