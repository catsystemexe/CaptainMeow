...
assert.match(source,/this\.renderV2Environment\(v2Scene\)\);[\s\S]*?renderV2ContextualYSurface\(\)[\s\S]*?this\.renderPreview/,"contextual Y is composed below Environment/Static Bgr and above tools");
