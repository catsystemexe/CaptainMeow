...
const overlaySync = ui.slice(ui.indexOf("private syncOverlay"), ui.indexOf("private pointerInternal"));
assert.doesNotMatch(ui, /syncV2SelectionOverlay|V2 canvas selection/, "normal V2 authoring builds no canvas hit areas");
assert.match(overlaySync, /if\(v2Scene\)\{this\.removeOverlay\(\);return;\}/, "normal V2 authoring removes the overlay");
