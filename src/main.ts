...
import { clearBackgroundPreviewState, disableTypedBackground, enableB2BackgroundSceneDemo, enableBackgroundV2DesertTest, enableBackgroundV2MissingAssetVerification, enableBackgroundV2VisualVerification, enableM4BackgroundV2Demo, getBackgroundState } from "./render/BackgroundState";
...
(window as any).__CM.bgrVerify = {
  ...
  desert: () => enableBackgroundV2DesertTest(globalThis),
  missingAsset: () => enableBackgroundV2MissingAssetVerification(globalThis),
  clear: () => disableTypedBackground(globalThis),
};
