...
export interface MigratedBuiltinPreset { readonly legacyGraphId: string; readonly preset: import("./schema").FsmPresetSchemaV1; readonly issues: readonly ValidationIssue[]; }
