...
const SMOKES = [
  ...
  "../render/bg/v2/BackgroundV2SequenceVerificationScene.smoke",
  "../render/bg/v2/BackgroundV2TriggerVerificationScene.smoke",
  ...
  "../ui/PixelBgrStaticBackdropUI.smoke",
